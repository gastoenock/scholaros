...
function SchoolSettingsContent({ groups, groupLabels, fieldsByGroup, values: initialValues }: PageProps) {
  ...
  const handleSave = () => {
    setSaving(true);
    router.put("/dashboard/settings", { settings: values }, {
      preserveScroll: true,
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Configure system-wide preferences for this school. Only administrators can change these values.
          </p>
        </div>
...
export default function SchoolSettingsPage(props: PageProps) {
  return (
    <DashboardLayout>
